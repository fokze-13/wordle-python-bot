...
has_played_daily_game = "<b>Извини, но ты уже играл сегодня</b>\nВозвращайся через <b>{time}</b>\nНо ты можешь сыграть другой режим"

default_answer = "Извини но я тебя не понял, попробуй ввести команду /help что бы увидеть список команд"

has_pressed_button = "Выбери что-нибудь другое"
